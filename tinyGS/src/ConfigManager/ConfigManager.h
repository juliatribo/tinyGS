...
#define MODEM_DEFAULT "{\"mode\":\"LoRa\",\"freq\":868,\"bw\":125.0,\"sf\":11,\"cr\":5,\"sw\":18,\"pwr\":5,\"cl\":120,\"pl\":8,\"gain\":0,\"crc\":true,\"fldro\":1,\"sat\":\"Norbi\",\"NORAD\":46494}"
...
public:
  ...
  void concatenate_unix(byte* TC,  size_t length, uint8_t* concatenated);
  int encode(byte* TC,  size_t length, uint8_t* encoded);
