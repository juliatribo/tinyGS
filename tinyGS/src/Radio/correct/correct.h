...
static const size_t BLOCK_LENGTH_RS = 255;
static const size_t MIN_DISTANCE_RS = 32;
static const size_t MESSAGE_LENGTH_RS = 223;

static const size_t RATE_CON = 2;
static const size_t ORDER_CON = 7;

static const int BLOCK_ROW_INTER = 4;
static const int BLOCK_COL_INTER = 4;
