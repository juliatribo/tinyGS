...
struct correct_reed_solomon {
    ...
    polynomial_t_rs generator;
    field_element_t *generator_roots;
    field_logarithm_t **generator_root_exp;

    polynomial_t_rs encoded_polynomial;
    polynomial_t_rs encoded_remainder;

    field_element_t *syndromes;
    field_element_t *modified_syndromes;
    polynomial_t_rs received_polynomial;
    polynomial_t_rs error_locator;
    polynomial_t_rs error_locator_log;
    polynomial_t_rs erasure_locator;
    ...
    polynomial_t_rs last_error_locator;

    // used during error value search
    polynomial_t_rs error_evaluator;
    polynomial_t_rs error_locator_derivative;
    polynomial_t_rs init_from_roots_scratch[2];
